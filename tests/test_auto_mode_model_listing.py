...
def test_error_listing_respects_env_restrictions(monkeypatch, reset_registry):
    ...
    monkeypatch.setenv("GOOGLE_ALLOWED_MODELS", "gemini-3.1-pro")
    monkeypatch.setenv("OPENAI_ALLOWED_MODELS", "gpt-5.2")
    monkeypatch.setenv("OPENROUTER_ALLOWED_MODELS", "deepseek")
    ...
    for key, value in (
        ...
        ("GOOGLE_ALLOWED_MODELS", "gemini-3.1-pro"),
        ("OPENAI_ALLOWED_MODELS", "gpt-5.2"),
        ("OPENROUTER_ALLOWED_MODELS", "deepseek"),
        ("XAI_ALLOWED_MODELS", ""),
    ):
