...
GEMINI_REPLAY_ID = "chat_cross/step1_gemini3_flash_preview_number/mldev"
GEMINI_REPLAY_PATH = GEMINI_CASSETTE_DIR / "chat_cross" / "step1_gemini3_flash_preview_number" / "mldev.json"
...
async def test_chat_cross_model_continuation(monkeypatch, tmp_path):
    ...
    with monkeypatch.context() as m:
        ...
        m.setenv("GOOGLE_ALLOWED_MODELS", "gemini-3-flash-preview")
        ...
        gemini_provider = ModelProviderRegistry.get_provider_for_model("gemini-3-flash-preview")
