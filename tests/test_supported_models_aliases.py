...
class TestSupportedModelsAliases:
    ...
    def test_gemini_provider_aliases(self):
        ...
        assert "pro" in provider.MODEL_CAPABILITIES["gemini-3.1-pro"].aliases
        ...
        assert provider._resolve_model_name("pro") == "gemini-3.1-pro"
    ...
    def test_list_models_all_known_variant_includes_aliases(self):
        ...
        assert "gemini-3.1-pro" in gemini_all
