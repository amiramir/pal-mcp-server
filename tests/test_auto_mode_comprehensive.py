    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {
                    "EXTENDED_REASONING": "gemini-3.1-pro",  # Gemini 3.1 Pro Preview for deep thinking
            ...
            (
                ...
                {
                    "EXTENDED_REASONING": "gemini-3.1-pro",  # Gemini 3.1 Pro Preview comes first in priority
